...
FAOSTATNEWOLAP.limitPivotPreview = 500;//lignes paging
...
function decolrowspanNEW(){
   ...
   try{ var testtd = document.getElementById("hor-minimalist-b").getElementsByTagName('td');
    ...
    else{ document.getElementById('csvData').value=ret;   
...
console.log(opts.aggregators)
        ...
        tr3 = $("<tr>");
        tr3.append($("<td>"));
        tr3.append($("<td valign='top' id='cols' class='pvtAxisContainer pvtHorizList'>").append($("<span style=' float: left;width: 80px;'>Columns</span>")));
        uiTable.append(tr3);
        tr2 = $("<tr>");
        ...
        for (_l = 0, _len4 = _ref5.length; _l < _len4; _l++) {
            ...
            if (_l == 0) {
                if (!FAOSTATNEWOLAP.nestedby) {
                    ...
                    this.find("#rows").append($("<span  style=' float: left;width: 80px;' >Group by</span>"));
                }
            ...
            for (var testi = 0; testi < c.length; testi++) {
                ...
                if (testi == 0) {
                    if (!FAOSTATNEWOLAP.nestedby) {
                        ...
                        $("#rows").append($("<span  style=' float: left;width: 80px;' Group by</span>"));
                    }
                }
