define({
  ...
  "queries": {
    ...
    "select_from_compare_ifa": "select element_code, element_label, year, coalesce(value, -1), um from ( select element, year, value, um from country_stat where fertilizer = '{PRODUCT}' and country = '{COUNTRY}' and n_p = '{KIND}' ) c right join codes_elements on element = element_code ORDER BY element ASC, year ASC",
