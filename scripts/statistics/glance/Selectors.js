...
/*
    ...
    Selectors.prototype._initProductSelector = function () {
        ...
        console.log(this._replace(this.config.queries.product_by_source, {SOURCE: defaultValues.DATA_SOURCE}))

        Wds.get({
            query: this._replace(this.config.queries.product_by_source, {SOURCE: defaultValues.DATA_SOURCE}),
            success: function (res) {
        ...
        function createNode(item) {
            ...
            var config = {
                id: item[1], // will be autogenerated if omitted
                text: item[0], // node text
                parent: '#'
